...
public abstract class DictionaryDrawer<TK, TV> : PropertyDrawer
{
    ...
    private static readonly GUIContent iconToolbarPlus = EditorGUIUtility.IconContent("Toolbar Plus", "Add to list");
...
[CustomPropertyDrawer(typeof(StatIntDictionary))]
public class CustomStatDictionaryInt : DictionaryDrawer<StatNames, int>
{
}

[CustomPropertyDrawer(typeof(StatFloatDictionary))]
public class CustomStatDictionaryFloat : DictionaryDrawer<StatNames, float>
{
}